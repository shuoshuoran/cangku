...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof test.demo.dahua.com.testlistview.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new test.demo.dahua.com.testlistview.GlideOptions().apply(toSet));
    }
  }
}
