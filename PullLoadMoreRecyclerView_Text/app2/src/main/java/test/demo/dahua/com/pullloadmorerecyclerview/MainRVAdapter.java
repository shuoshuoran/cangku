...
public class MainRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
       ...
       /* TextHolder textHolder = (TextHolder) holder;
        textHolder.item_View.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
           onItemitemClickListener.itemClick(position);
            }
        });*/
  ...
  public   onItemitemClickListener onItemitemClickListener;
    ...
    public void setOnItemitemClickListener(MainRVAdapter.onItemitemClickListener onItemitemClickListener) {
